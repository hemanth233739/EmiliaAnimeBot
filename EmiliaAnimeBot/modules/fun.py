...
from EmiliaAnimeBot import DEMONS, DRAGONS, pgram as bot, dispatcher, BOT_USERNAME
...
__help__ = """
  ...
  ➢ `/hug`*:* hug someone or get hugged by Yuuki
  ➢ `/love`*:* Checks Love in your heart weather it's true or fake
  ➢ `/kiss`*:* Kiss someone or get kissed 
  ➢ `/flirt`*:* Yuuki will flirt to the replied person or with you
  ➢ `/lewd`*:* Yuuki will act lewd with you or with the replied person
  ➢ `/romance`*:* Yuuki will act all romantic with you or replied person
